...
@Named("positionController_ad")
@SessionScoped
public class PositionController_ad implements Serializable {
    ...
    public static class PositionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PositionController_ad controller = (PositionController_ad) facesContext.getApplication().getELResolver().
