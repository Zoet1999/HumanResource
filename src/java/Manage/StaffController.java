...
public class StaffController implements Serializable {
    ...
    private List<StaffPosition> staffs;
    ...
    public List<StaffPosition> getStaffs(int companyid, String departmentid) {
        staffs = getFacade().findStaffs(companyid, departmentid);
        return staffs;
    }

    public List<String> getPositions() {
        List<String> ss = new ArrayList<String>();
        ss = getFacade().getStaffPos();
        return ss;
    }

    public void setStaffs(List<StaffPosition> staffs) {
        this.staffs = staffs;
    }
