...
@Named("experienceController_ad")
@SessionScoped
public class ExperienceController_ad implements Serializable {

    private Experience current;
    private DataModel items = null;
    @EJB
    private session.ExperienceFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public ExperienceController_ad() {
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ExperienceCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ExperienceUpdated"));
            return "List";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ExperienceDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ExperienceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ExperienceController_ad controller = (ExperienceController_ad) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Experience) {
                ...
                return getStringKey(o.getExpNo());
            } else {
